...
net user Delwar del674569 /add >nul
net localgroup administrators Delwar /add >nul
net user Delwar /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant Delwar:F >nul
ICACLS C:\Windows\installer /grant Delwar:F >nul
